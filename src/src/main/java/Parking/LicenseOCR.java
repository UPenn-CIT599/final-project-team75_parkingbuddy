...
class LicenseOCR {
	final static String urlStr = "https://api.openalpr.com/v2/recognize"
			+ "_bytes?recognize_vehicle=1&country=us&secret_key=";
	...
	private Car getCarFromJSON(String jsonString) {
		...
		String state = result.getJSONObject(0).getString("region")
				.toUpperCase();
