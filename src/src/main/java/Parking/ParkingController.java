 ...
 * call all relevant classes to process tickets or add parking instances to the
 * SQL database.
 */
...
class ParkingController {
	...
	/**
	 * Add parking instances to the database based on folder or image file
	 * input.
	 * 
	 * @param filePath
	 */
	...
	/**
	 * This method creates a violation report based on the user inputted
	 * timeframe.
	 * 
	 * @param startDate
	 * @param endDate
	...
	public ArrayList<ParkingAggregate> getParkingAggregates(LocalDate startDate,
			LocalDate endDate) {
		ArrayList<ParkingAggregate> parkingResults = db
				.getAggregatedParkingInstances(startDate, endDate);
	...
	public static void main(String[] args) {
		...
		results = pc.getParkingAggregates(LocalDate.of(2010, 2, 11),
