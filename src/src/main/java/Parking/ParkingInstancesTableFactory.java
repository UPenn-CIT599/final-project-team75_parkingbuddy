...
public class ParkingInstancesTableFactory {
  ...
  public static TableView<ParkingInstance> createParkingInstancesTable(
    ...
    if (includeCarCols) {
      ...
      stateCol.setCellValueFactory(new PropertyValueFactory<ParkingInstance, String>("state"));

      // License
      licenseCol = new TableColumn<ParkingInstance, String>("License");
      licenseCol.setMinWidth(200);
      licenseCol.setCellValueFactory(new PropertyValueFactory<ParkingInstance, String>("license"));
    }
    ...
    dateCol
        .setCellValueFactory(new PropertyValueFactory<ParkingInstance, LocalDateTime>("dateTime"));
    ...
    photoCol
        .setCellValueFactory(new PropertyValueFactory<ParkingInstance, BufferedImage>("thumbnail"));
